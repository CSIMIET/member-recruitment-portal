    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white py-8 px-4">
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="fixed inset-0 bg-white bg-opacity-95" onClick={() => setShowSuccessModal(false)}></div>
          <div className="bg-white rounded-xl shadow-xl p-8 max-w-md w-full mx-4 relative z-10 transform transition-all border border-gray-200">
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                ...
                <div className="mb-4">
                  ...
                  >
                    ...
                    <option value="Less than 2 hours" className="text-gray-800">&lt;2 hrs</option>
                    <option value="2-4 hours" className="text-gray-800">2–4 hrs</option>
                    <option value="5-7 hours" className="text-gray-800">5–7 hrs</option>
                    <option value="7+ hours" className="text-gray-800">7+ hrs</option>
                  </select>
                </div>
